...
class Calculator(QWidget):
    ...
    def initUI(self):
        self.setGeometry(400, 300, 280, 370)
        ...
        self.div2 = QPushButton('//', self)
        self.div2.resize(50, 50)
        self.div2.move(225, 100)
        ...
        self.prc = QPushButton('%', self)
        self.prc.resize(50, 50)
        self.prc.move(225, 155)
        ...
        self.step2 = QPushButton('^2', self)
        self.step2.resize(50, 50)
        self.step2.move(225, 210)
        ...
        self.div2.clicked.connect(self.div2_1)
        self.prc.clicked.connect(self.prc_1)
        self.step2.clicked.connect(self.step2_1)
    ...
    def step2_1(self):
        self.operation = '^2'
        self.operand_1 = float(self.label.text())
        self.operand_2 = str(self.label.text())
        # self.operand_2 = 2
        self.label.setText('')
